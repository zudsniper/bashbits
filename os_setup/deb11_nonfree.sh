...
REQUIRED_PACKAGES=("curl" "git" "gh" "jq" "certbot" "nginx" "ufw" "net-tools" "snapd" "htop" "tmux" "vim" "build-essential" "tree" "zip" "unzip" "terminator" "vim" "opensshd" "letsencrypt" "python3" "python-is-python3" "pipx" )
